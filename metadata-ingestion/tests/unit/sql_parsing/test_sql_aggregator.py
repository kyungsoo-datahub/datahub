...
def test_partial_empty_downstream_column_in_snowflake_lineage(
    ...
    downstream_urn = DatasetUrn("snowflake", "dev.public.emptycol3").urn()
    upstream_urn = DatasetUrn("snowflake", "dev.public.emptycol").urn()

    known_query_lineage = KnownQueryLineageInfo(
        query_text='create table emptycol3 as select $1 as "", $2 as "TITLE2" from emptycol',
        downstream=downstream_urn,
        upstreams=[upstream_urn],
        column_lineage=[
            ColumnLineageInfo(
            ...
            ColumnLineageInfo(
                downstream=DownstreamColumnRef(table=downstream_urn, column="TITLE2"),
